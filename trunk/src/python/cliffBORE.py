...
class CliffBORE:
    ...
    def __init__(self,data):
        self.VirginData = data
        self.data = deepcopy(self.VirginData)
        self.classes = self.PopulateClasses(self.data)
    ...
    def GetCriteria(self,data):
        ...
        for br in BestAndRestSets:
            result = self.rankvals(br[0],br[1])
            results.append(result[0:int(math.floor(float(len(result)) * 0.15))])
        return results
